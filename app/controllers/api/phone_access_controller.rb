...
module Api
  class PhoneAccessController < Api::ApplicationController
    ...
    def phone_number_token
      ...
      @user = User.joins(:phone_numbers).find_by phone_numbers: { phone_number: PhonyRails.normalize_number(
        params[:phone_number], default_country_code: 'BG'
      ) }
